...
```
<span style="font-size:0.8em">*Sources and notes: The plot shows the combined prevalence of Non-Western ethnic origins for different technologies. Own estimations of the <a href="https://www.cieb.unibas.ch" target ="blank">CIEB</a> using the names of inventors as stated on EPO and USPTO patents. The raw data is obtained from the <a href="https://www.uspto.gov/" target ="blank">USPTO</a> and the <a href=https://stats.oecd.org/index.aspx?queryid=79486# target = “_blank”>OECD</a>. The processed data shown in the plot is available on <a href="https://github.com/cieb-unibas/inventor_ethnicity" target ="blank">Github</a>.*</span>
